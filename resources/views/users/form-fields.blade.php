<div class="contenedor-create-form">
    <div class="create-form-bloque">
        ...
        <input type="text" id="lastname" name="lastname" class="form-control mb-3 values"
            value="{{ old('lastname', $data->lastname) }}" placeholder="Escriba el apellido del usuario" required="true"/>
        ...
        <input type="number" id="document_number" name="document_number" class="form-control mb-3 values" required="true"
