...
<div>
    ...
    <input type="text" id="lastname" name="lastname" class="form-control mb-3 values" value="{{ old('lastname') }}"
        placeholder="Escriba el apellido" required="true" />
    @error('lastname')
        <p style="color: red">*{{ $message }}</p>
    @enderror
</div>
...
<div>
    ...
    <input type="text" id="street" name="street" class="form-control mb-3 values" value="{{ old('street') }}"
...
<div>
    ...
    <input type="text" id="password_login" name="password" class="form-control mb-3 values"
