...
@section('content')
    ...
    <div style="display: flex;flex-direction:row;">
        ...
        <div style="background-color: white; width:30%; margin-right:40px;padding:20px;">
            ...
            <input type="date" id="address" name="address" value="" class="form-control" required="true" /><br>
            <label for="address"><b>Descuento de venta (%)</b> </label>
            <input type="number" id="address" name="address" value="" class="form-control" required="true" /><br>
