        ...
        <form action="{{ route('provider.update', $id) }}" method="post">
            ...
            <div class="contenedor-create-form">
                ...
                <div class="create-form-bloque">
                    ...
                    <input type="text" id="cellphone" name="cellphone" value="{{ $obj->cellphone }}" class="form-control"
                        placeholder="Escriba su teléfono" required="true" /><br>
                </div>

                <input type="text" id="dateEdited" name="dateEdited" readonly hidden value="<?= date('Y-m-d H:i:s') ?>" />
